...
# Office Update UI behavior
Set-RegistryValue -Path "HKLM:\Software\Policies\Microsoft\Office\16.0\Common\Officeupdate" -Name "hideupdatenotifications" -Type "DWord" -Value "1"
